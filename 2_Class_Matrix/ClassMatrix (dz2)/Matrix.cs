...
namespace ClassMatrix__dz2_
{
    class Matrix
    {
        ...
        {
            Matrix resMass = new Matrix(a.N);
            if (Matrix.det(a.N) > Matrix.det(a.N)):
        ...
        */
        ...
        //public static Matrix TryParse(string s, out double result)
        //{
        //    Matrix resMass = new Matrix(2);
        //    string[] str = s.Split(',');
        //    double NUM;
        ...
        //        {
        //            Console.WriteLine("'{0}' --> {1}", value, NUM);
        //            b = true;
        //        }
        //        else
        //            Console.WriteLine("invalid '{0}'.", value);
        //            b = false;
        //        if (b==true)
        //        {
        //            resMass[0, 0] = NUM;
        ...
        //    d = resMass[1, 1];
        //    str[0] = str[0].Substring(1); //тут должно быть только число
        //    if (Double.TryParse(str[0], out a))
        //        Console.WriteLine("'{0}' --> {1}", str[0], a);
        //    else
        //        Console.WriteLine("Не вещественное число '{0}'.", str[0]);

        //    str[1] = str[1].Substring(0, str[1].Length - 1);
        //    if (Double.TryParse(str[1], out b))
        //        Console.WriteLine("'{0}' --> {1}", str[1], b);
        //    else
        //        Console.WriteLine("Не вещественное число '{0}'.", str[1]);

        //    str[2] = str[2].Substring(1);
        //    if (Double.TryParse(str[2], out c))
        //        Console.WriteLine("'{0}' --> {1}", str[2], c);
        //    else
        //        Console.WriteLine("Не вещественное число '{0}'.", str[2]);

        //    str[3] = str[3].Substring(0, str[3].Length - 1);
        //    if (Double.TryParse(str[3], out d))
        //        Console.WriteLine("'{0}' --> {1}", str[3], d);
        //    else
        //        Console.WriteLine("Не вещественное число '{0}'.", str[3]);
